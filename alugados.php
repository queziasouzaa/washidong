...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./alugados.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Alugados</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Livros Alugados</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                    ...
                    <div class="card">
                      <div class="card-header border-transparent">
                        ...
                        <div class="card-tools d-flex">
                          <input class="form-control" id="srci" type="search" placeholder="Procurar"/>
                        ...
                        <div class="table-responsive">
                          <table class="table m-0">
                            ...
                            <tr>
                              ...
                              <th class="col-2">Data de Aluguel</th>
  ...
  <div class="modal fade bd-example-modal-xl" id="modal_lead_tab" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    <div class="modal fade bd-example-modal-xl" id="modal_nota_tab" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-xl">
        <div class="modal-content ">
          <div class="modal-header text-center">
            <h4 class="modal-title white-text w-100 font-weight-bold py-2">Nota</h4>
            <button type="button" id="fechar_tabela" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true" class="white-text">&times;</span>
            </button>
          </div>
          ...
          <div class="modal-body">
            <div id="tabela_head" class="row">
                <div class="form-group col-md-6 d-flex flex-column">
                    <label class="text-info" ><b>Que nota você daria para este Livro</b></label>
                    <input id="livroid" type="hidden" value="">
                    <div>
                    <div class="rating">
                      <label>
          ...
          <div class="modal-footer justify-content-center">
           <button type="button" class="btn btn-danger" data-dismiss="modal" aria-label="Close">Cancelar</button>
           <button type="button" class="btn btn-success" onclick="devolver_livro()">Salvar</button>
           </div>
        </div>
      </div>
    </div>
...
<script>
  ...
  function devolver(livro){
      ...
      nota = 0;
      $('#modal_nota_tab').modal('toggle');
      $('#modal_nota_tab').modal('show');
  }
  function devolver_livro(){
            
    let user = <?php echo $id;?>;
    let livro = $('#livroid').val();
